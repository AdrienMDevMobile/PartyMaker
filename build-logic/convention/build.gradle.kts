...
gradlePlugin {
    plugins {
        register("androidApplicationCompose") {
            id = libs.plugins.partymaker.android.application.compose.get().pluginId
            implementationClass = "AndroidApplicationComposeConventionPlugin"
        }
        register("androidApplication") {
            id = libs.plugins.partymaker.android.application.asProvider().get().pluginId
            implementationClass = "AndroidApplicationConventionPlugin"
        }
        register("androidLibraryCompose") {
            id = libs.plugins.partymaker.android.library.compose.get().pluginId
